...
## Project Structure
    ...
    ├── weathered_forest_de_83366  # Django project configurations
...
1. Clone this repo and `cd weathered_forest_de_83366`
...
2. Clone this repo and `cd weathered_forest_de_83366`
